...
public class Drivetrain extends SubsystemBase {
  ...
  // public void arcadeDriveFBumpM(double a_speed, double a_turn) {
  ...
  // public void arcadeDriveTriggers(double a_speed, double a_turn) {
  ...
  // // redundant to have the bumpers still act as multipliers, but it could still
  // be
  ...
  // speed = speed * 1;
  // turn = turn * 1;
  // // I know it doesn't do anything the point of it is to show that it doesn't
  // have
  ...
  public void arcadeDriveDTrigM(double a_speed, double a_turn) {
    double speed = a_speed;
    double turn = a_turn;
    if (RobotContainer.driveD.btn_RTrig.get()) {
      speed = speed * RobotPreferences.drivetrainHighSpeed.getValue();
      turn = turn * RobotPreferences.drivetrainHighTurnSpeed.getValue();
    } else if (RobotContainer.driveD.btn_LTrig.get()) {
      speed = speed * RobotPreferences.drivetrainLowLowSpeed.getValue();
      turn = turn * RobotPreferences.drivetrainTurnLowLowSpeed.getValue();
    } else {
      speed = speed * RobotPreferences.drivetrainLowSpeed.getValue();
