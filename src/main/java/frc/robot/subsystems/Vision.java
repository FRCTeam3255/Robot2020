...
public class Vision extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // Core.inRange(output,
    // new Scalar(RobotPreferences.hLow.getValue(),
    // RobotPreferences.sLow.getValue(),
    // RobotPreferences.vLow.getValue()),
    // new Scalar(RobotPreferences.hHigh.getValue(),
    // RobotPreferences.sHigh.getValue(),
    ...
    // Imgproc.findContours(binary, contours, heirarchy, Imgproc.RETR_TREE,
