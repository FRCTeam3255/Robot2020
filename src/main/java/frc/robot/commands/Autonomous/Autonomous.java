...
public class Autonomous extends CommandBase {
  ...
  public Autonomous() {
    ...
    auto1Align1 = new AlignAuto(RobotPreferences.auto1SusanPos, RobotPreferences.auto1HoodPos, RobotPreferences.auto1Delay);
    auto2Align1 = new AlignAuto(RobotPreferences.auto2SusanPos, RobotPreferences.auto2HoodPos, RobotPreferences.auto2Delay);
  ...
  public void initialize() {
    ...
    // determine which set of motion profiles and alignment commands to use based on switchboard button 1
