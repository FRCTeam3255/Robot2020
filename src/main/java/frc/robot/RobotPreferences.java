...
public class RobotPreferences {
    ...
    public static final SN_IntPreference visionTimeout = new SN_IntPreference("visionTimeout", 50);
    ...
    public static final SN_IntPreference motProfSensorUnitsPerFt = new SN_IntPreference("motProfSensorUnitsPerFt",
            11700);
    public static final SN_DoublePreference motProfNeutralDeadband = new SN_DoublePreference("motProfNeutralDeadband",
            0.001);
    ...
    // Climber
    public static final SN_DoublePreference climberCountsPerInches = new SN_DoublePreference("climberCountsPerInches",
            400);
    ...
    public static final SN_DoublePreference susanVisionP = new SN_DoublePreference("susanVisionP", 0.0025);
    public static final SN_DoublePreference susanSpeed = new SN_DoublePreference("susanSpeed", 0.2);
    public static final SN_DoublePreference susanSpeedBackwards = new SN_DoublePreference("susanSpeedBackwards", -0.2);
    ...
    public static final SN_DoublePreference shooterTolerance = new SN_DoublePreference("shooterToleranceSpeed", 100);
    // ControlPanel
